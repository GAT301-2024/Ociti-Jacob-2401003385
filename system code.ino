...
// Wi-Fi credentials
const char *ssid = "98@air";
const char *password = "atljacob";

// Authentication
const char *ADMIN_USER = "Ociti Jacob";
...
// HTML Footer
String htmlFooter() {
  return "<footer>Group: Logical_Loopers<br>Developed by Ociti Jacob</footer></body></html>";
}
